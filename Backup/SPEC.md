...
```json
{
  "property": { "id": "p_1", "name": "ตี๋หิด คอนโด", "type": "CONDO", "typeLabel": "คอนโด", "plan": "PREMIUM" },
  "user": { "displayName": "คุณตี๋หิด", "role": "OWNER", "avatarUrl": null },
  ...
  "latestRooms": [
    {
      ...
      "tenantName": "น.ส.ผู้เช่าสมมุติ 01", "leaseEndDate": "2026-01-31"
    }
  ],
  "recentPayments": [
    {
      "id": "p_1", "tenantName": "น.ส.ผู้เช่าสมมุติ 01", "avatarUrl": null,
...
- โครงการ/ที่พัก: **ตี๋หิด คอนโด** (หรือห้องเช่าสุขสันต์, PREMIUM, กำหนดประเภทได้จากหลังบ้าน เช่น คอนโด, ห้องเช่า, หอพัก)
- ผู้ใช้: คุณตี๋หิด — เจ้าของ / ผู้จัดการโครงการ
...
|---|---|---|---|---|---|
| 101 | 1 | 3,500 | น.ส.ผู้เช่าสมมุติ 01 | 31 ม.ค. 2569 | มีผู้เช่า |
| 102 | 1 | 3,500 | นายผู้เช่าสมมุติ 02 | 15 ก.พ. 2569 | มีผู้เช่า |
| 103 | 1 | 3,800 | - | - | ว่าง |
| 104 | 1 | 3,800 | น.ส.ผู้เช่าสมมุติ 03 | 20 ธ.ค. 2568 | มีผู้เช่า |
| 105 | 1 | 3,800 | นายผู้เช่าสมมุติ 04 | 10 ม.ค. 2569 | มีผู้เช่า |

การชำระล่าสุด (ทั้งหมด PAID):

| ผู้เช่า | ห้อง | จำนวน | เวลา |
|---|---|---|---|
| น.ส.ผู้เช่าสมมุติ 01 | 101 | 3,500 | 11 ก.ย. 2568 20:05 น. |
| นายผู้เช่าสมมุติ 02 | 102 | 3,500 | 11 ก.ย. 2568 19:42 น. |
| น.ส.ผู้เช่าสมมุติ 03 | 104 | 3,800 | 11 ก.ย. 2568 18:30 น. |
| นายผู้เช่าสมมุติ 04 | 105 | 3,800 | 11 ก.ย. 2568 17:20 น. |
| นายผู้เช่าสมมุติ 05 | 108 | 3,500 | 10 ก.ย. 2568 16:12 น. |
...
| `stripThaiTitle("น.ส.ผู้เช่าสมมุติ")` | string | `ผู้เช่าสมมุติ` (ใช้ทำ initials ของ avatar) |
